...
const FormSelectBox = ({ defaultName, defaultValue, children }) => {
    return (
        <div className='group peer relative cursor-pointer shadow-md outline-none' tabIndex='1'>
            ...
            <MdKeyboardArrowDown className='absolute top-1/2 right-4 h-6 w-6 -translate-y-1/2 opacity-70 transition-all group-focus:-translate-y-1/2 group-focus:rotate-180' alt='Arrow Icon' aria-hidden='true' />
        </div>
    )
}
